...
<section >
      ...
      <div class="bg-red-600 text-white text-2xl max-w-xl h-auto top-0 left-0 rounded-r-2xl px-6 py-4 font-bold">
        <p>Jadwal Rundown Pendaftaran Sekolah.com</p>
      </div>
  ...
  <a href="index.php">
      <div class="w-40 h-auto p-2 mx-6">
        <img src="images/beranda.png" class="w-20">
        <p class="font-bold">BERANDA</p>
      </div>
    </a>

    <a href="jadwal.php">
      <div class="w-40 h-auto p-2 mx-6">
        <img src="images/jadwal1.png" class="w-20">
        <p class="text-red-500 font-bold">JADWAL</p>
      </div>
    </a>
...
<div class="relative mx-auto flex flex-col mt-32 overflow-x-auto">
    <table class="w-4xl text-sm text-left  text-black shadow-2xl ">
        <thead class="text-xl text-center font-bold text-black uppercase bg-gray-50">
            <tr>
        ...
        <tbody>
          <tr class="bg-white border-2 border-gray-200">
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 border-gray-50">
              <div class="flex items-center gap-3">
                <img src="images/color-box.png" alt="Pendaftaran" class="w-10 h-10">
            ...
            <td class="px-6 py-4">
              Pendaftaran dimulai pukul 08:00 hari pertama sampai dengan pukul 12:00 di hari terakhir
            </td>
          </tr>
          ...
          <tr class="bg-white border-2 border-gray-200">
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 border-gray-50">
              <div class="flex items-center gap-3">
                <img src="images/oren.png" alt="Pendaftaran" class="w-10 h-10">
            ...
            <td class="px-6 py-4">
              Verifikasi dan Seleksi dimulai pukul 08:00 hari pertama sampai dengan pukul 14:00 di hari terakhir
            </td>
          </tr>
          ...
          <tr class="bg-white border-2 border-gray-200">
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 border-gray-50">
              <div class="flex items-center gap-3">
                <img src="images/hijau.png" alt="Pendaftaran" class="w-10 h-10">
            ...
            <td class="px-6 py-4">
              Pengumuman hasil seleksi akan diumumkan pada pukul 14:00
            </td>
          </tr>
          ...
          <tr class="bg-white border-2 border-gray-200">
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 border-gray-50">
              <div class="flex items-center gap-3">
                <img src="images/ungu.png" alt="Pendaftaran" class="w-10 h-10">
            ...
            <td class="px-6 py-4">
              24 jam Pendaftaran dimulai pukul 15:00 hari pertama sampai dengan pukul 21:00 di hari terakhir
            </td>
          </tr>
